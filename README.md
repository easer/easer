...
- easer-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- easer-ui: main application module, development time
- easer-production: module that produces a production mode WAR for deployment
